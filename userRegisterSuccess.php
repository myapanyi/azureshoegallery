...
<head>
    ...
    <title>AzureShoeGallery|UserRegisterSuccess</title>
	...
	<section id="cart_items">
		<div class="container">
			<div class="breadcrumbs">
				...
				<?php 
				if ($_SESSION['userRegisterSuccess']) {
					
				
				echo "<h1 class=\"welcomeDesign\">Register Successfully!Welcome  <span class=\"welcomeuser\">".$_SESSION['userRegisterSuccess']."</span><br><br>";
