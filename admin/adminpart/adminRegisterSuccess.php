...
<html lang="en">
  <head>
    ...
    <title>AzureShoeGallery|Member Register Success  </title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
        			  <div class="x_panel">
                  <div class="x_title">
                    <h2><div class="fa-hover col-md-3 col-sm-4 col-xs-12"><a href="#/info-circle"><i class="fa fa-info-circle"></i>  Register Success</a>
                        </div></h2>
                  ...
                  <div class="x_content" style="height:300px">
                    ...
                    <h1 class="welcome sorry">Welcome!&nbsp;&nbsp;<span class="successname"><?php if (isset($_SESSION['adminRegisterSuccess'])) {
                      echo $_SESSION['adminRegisterSuccess'];
                    }  ?></span>&nbsp;&nbsp;Register Success.</h1>
