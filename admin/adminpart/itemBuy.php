...
<html lang="en">
  <head>
    ...
    <title>AzureShoeGallery|Item Buy  </title>
        ...
        <div class="right_col" role="main">
             <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    $query = "select * from itemnew where itemcode='$itemcode'";
                    ...
                    ?>
                    <form id="itemBuy" data-parsley-validate class="form-horizontal form-label-left" onsubmit="return validateForm()" action="doItemBuy.php?itemcode=<?php echo $itemcode ?>" method="post">
                    <div class="form-group">
          <div class="col-md-55 imageLeft">
            <div class="thumbnail">
                          <div class="view view-first">

                            <?php echo "<img  style=\"width: 100%; height:194px;display: block;\" src=\"images/newarrival/". $row['imagepath']." \" alt=\"image\" />"; ?>
              <input type="hidden" name="img_path" value="<?php echo $row['imagepath']?>">
                      ...
                      <div class="form-group aligndetail">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                          ...
                          <input type="hidden" name="upitem" value="<?php echo $row['itemcode'];?>">
                        </div>

                      </div>
                      <div class="form-group aligndetail">
                        <label class=" col-md-3 col-sm-3 col-xs-12 ealignleft" for="first-name">Resale Item Code:
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                         <input type="text" id="itemcode" name="resaleCode" required="required" class=" col-md-7 col-xs-12" >
                        </div>
           ...
           <div class="form-group aligndetail">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label class=" col-md-7 col-xs-12" style="color:#0952c3"><?php echo $row['price']?></label>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 ">
                          ...
                          <input type="number" id="sprice" name="sprice" min="5000" required="required" class=" col-md-7 col-xs-12" >
                        </div>
                      </div>
                       <div class="form-group aligndetail">
            ...
            <?php
                      ...
                      <div class="form-group aligndetail">
                        <label class="col-md-3 col-sm-3 col-xs-12" for="first-name">Maximun Qty:
                        </label>
              <div class="col-md-6 col-sm-6 col-xs-12 ">

                           <label class=" col-md-7 col-xs-12" style="color:#0952c3"><?php echo $row['qty']?></label>
                          <input type="hidden" name="haveqty" value="<?php echo $row['qty'];?>">
                        </div>
                      </div>
                       <div class="form-group aligndetail">
                        <label class=" col-md-3 col-sm-3 col-xs-12 ealignleft" for="first-name">Qty:
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                         <input type="number" id="qty" name="qty" min="1" required="required" class=" col-md-7 col-xs-12" >
                         <input type="hidden" id="hiddenQTY" value="<?php echo $row['qty'];?>" >
                        </div>
                      </div>
                      <div class="form-group aligndetail">
                        <label class=" col-md-3 col-sm-3 col-xs-12 ealignleft" for="first-name">Buy Date:
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                          <input type="text" id="datepicker" name="createdDate" onchange="return checkForm()"  required="required" class=" col-md-7 col-xs-12" >
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 buttonLeft">

                          <button type="submit" id="submit" class="btn btn-success "><i class="fa fa-shopping-cart"></i>Buy Item</button>
                           
                           <button type="reset" class="cancelbtn">Cancel</button>
                           <a href="newArrival.php"><button type="button" class="btn btn-primary">Back</button></a>
                        </div>
                      </div>
          <?php }?>
...
$('#itemcode').change(function() {
    var itemcodeVal = $('#itemcode').val(); // assuming this is a input text field
    $.post('checkresalecode.php', {'itemcode' : itemcodeVal}, function(data) {
   if (data < 1)
   { 
   ...
   else
   {
        ...
        alert("Sorry .. Resale Code Already Exist");
...
$('#qty').change(function() {
    var qtyVal =parseInt($('#qty').val()) ; // assuming this is a input text field
  var hiddenQTY = parseInt($('#hiddenQTY').val()); 
      if(qtyVal > hiddenQTY)
    {
     
      document.getElementById('qty').value = "";
      alert("Sorry..Qty Not Enough");
      return false;
    }
    else
      return true;
  ...
  function checkForm(){
    ...
    // regular expression to match required date format
      var date = document.forms["itemBuy"]["datepicker"].value;
   ...
   // Create date from input value
      ...
      if(inputDate.setHours(0,0,0,0) < todaysDate.setHours(0,0,0,0)) {
        ...
        document.forms["itemBuy"]["datepicker"].value = '';
        return false;
      }
