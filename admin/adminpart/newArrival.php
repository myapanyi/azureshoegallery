...
<html lang="en">
  <head>
    ...
    <title>AzureShoeGallery|New Arrival  </title>
        ...
        <!-- page content -->
         <div class="right_col" role="main">
                  ...
                  <div class="x_content">
                    <br />
                    <?php
	                    $query = "Select * from itemnew ";
	                    $result = mysql_query($query);
	                    while ($row = mysql_fetch_assoc($result)):

                    ?>
					<div class="col-md-55 arriveitem">
						<div class="thumbnail" >
                          <div class="view view-first" style="height: 190px">
                            <?php echo "<img src=\" images/newarrival/". $row['imagepath']." \" alt=\"\" style=\"width:100%;height:100%;display:block\"  /><br />";?>

                          </div>
                        </div>
                        <label >Item Code:
                        </label>
                        <label class="ncode"><?php echo $row['itemcode'];?>
                        </label>
                        <br>
                        <label >Price&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:
                        </label>
                        <label class="ncode"><?php echo $row['price'];?>
                        </label>
                        <br>

						 <a href="itemDetail.php?itemcode=<?php echo $row['itemcode'];?>"><button type="button" class="btn btn-info ndetail" >Detail</button></a>
						 <a href="itemBuy.php?itemcode=<?php echo $row['itemcode'];?>"><button type="submit" class="btn btn-success "><i class="fa fa-shopping-cart"></i>
                        Buy Item</button></a>
                        </div>
						<?php endwhile;?>
                  </div>
