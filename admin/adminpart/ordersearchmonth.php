...
<html lang="en">
  <head>
    ...
    <title>AzureShoeGallery|Order List </title>
      ...
      <div class="main_container">
        ...
        <div class="x_panel">
                    ...
                    <div class="clearfix"></div>
				      ...
				      <div class="x_content">
					      ...
					      <div class="title_right">
					         <a href="orderList.php"><button type="button" class="btn btn-success"> <-Back </button></a>
							...
							<?php  if(isset($_POST['search']))
			                  {
			                  	...
			                  	$month = mysql_real_escape_string($_POST['selected_text']); // get the selected text

			                  }?>

            <form method="POST" action="ordersearchmonth.php" >


                <div class="input-group">
                <select id="cmbMake" name="Make" class="form-control"    onchange="document.getElementById('selected_text').value=this.options[this.selectedIndex].value">
         ...
         date_default_timezone_set(UTC);
                  ...
                  $currentyear = date("Y");
                  $result = mysql_query("SELECT orderitemcode,customID,ordercategory,orderprice,totalprice,orderqty,orderimagepath,STR_TO_DATE('orderdate', '%m/%d/%Y') as todaydate,orderdeadline
									FROM azsc.order WHERE orderdeadline like '$currentyear-$month-%' ORDER BY orderdate")OR DIE('query is not available!');
                  $count = mysql_num_rows($result);


                  ?>
                    <div id="content" class="recontent">
  ...
  Display_Load();
    ...
    $("#content").load("ordermonthpagination.php?page=1&month="+month, Hide_Load());
  ...
  $("#pagination li").click(function(){
    ...
    $("#content").load("ordermonthpagination.php?page=" + pageNum+"&month="+month, Hide_Load());
  });
