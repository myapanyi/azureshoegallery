...
<html lang="en">
  <head>
    ...
    <title>AzureShoeGallery|Item Detail  </title>
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
                  ...
                  <div class="x_content">
                    ...
                    ?>
                    <form id="detail_form"  data-parsley-validate class="form-horizontal form-label-left"  >
					...
					<div class="col-md-55 alignimage">
                      ...
                      <div class="form-group aligndetail">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 ">
                          <label class=" col-md-7 col-xs-12 " style="color:#0952c3"><?php echo $itemcode?></label>
                        </div>
					 ...
					 <div class="form-group aligndetail">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 alignbutton">
                          ...
                          <a href="itemBuy.php?itemcode=<?php echo $row['itemcode']?>"><button type="button" class="btn btn-success "><i class="fa fa-shopping-cart"></i>Buy Item</button></a>
