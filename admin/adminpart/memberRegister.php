...
<html lang="en">
  <head>
    ...
    <title>AzureShoeGallery|Member Register  </title>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="domemberRegister.php" method="post" onsubmit="return validateRegister() " enctype="multipart/form-data">
					...
					<div class="col-md-55 alignimage">
						<div class="thumbnail" id="fileList">
                          <div class="view view-first">
                            ...
                            <?php echo "<img  class=\"resize_img\" style=\"width: 100%; height:100%;display: block;\" src=\"images/employee/user.png \" alt=\"image\" />"; ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="name" required="required" name="name" class="form-control col-md-7 col-xs-12" onchange="validateName()">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Password <span class="colorreq required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Confirm Password <span class="colorreq required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="confirmpassword" onchange="validatePassword()" required="required" class="form-control col-md-7 col-xs-12" type="password" name="confirmpassword">
                        </div>
                      </div>
                       <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="phoneno" min="0" class="form-control col-md-7 col-xs-12" type="number" name="phoneno">
                        </div>
                      </div>
                      <div class="form-group">
