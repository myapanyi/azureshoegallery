    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col" role="main">
                  ...
                  <div class="x_content">
                    <br />
                    <h1 class="welcome">Welcome! AzureShoeGallery...</h1>

                    <div class="bs-glyphicons">
        			<ul class="bs-glyphicons-list">
						<li class="listneed">
                            <a href="itemList.php"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
                            <span class="glyphicon-class">Item List</span></a>
                          </li>
                          <li class="listneed">
                            <a href="orderList.php"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
                            <span class="glyphicon-class">Order List</span></a>
                          </li>
                      </ul>
