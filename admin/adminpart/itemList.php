...
<html lang="en">
  <head>
    ...
    <title>AzureShoeGallery|Search Item  </title>
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
                ...
                <h3><?php echo "Photo"; ?></h3>
                 ...
                 <ul class="nav side-menu">
                  <li><a href="index.php"><i class="fa fa-home"></i> Admin Menu </a></li>
                      ...
                      <a href="searchItem.php" class="leftmenunav">Item List </a></li>
                      <li style="list-style:none;size:20px">
        ...
        <div class="x_panel">
         <div class="x_title">
                 ...
                 ?>
             <form action="itemList.php" method="post" id="searchForm">
             <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search for..." name="search">
                            <input type="hidden" name="hsearch" value="<?php echo $search;?>">
                     ...
                     <div>
                     <a href="newArrival.php"><button type="button" class="btn btn-success">Item Buy</button></a>
                    <form name="myform">
				  ...
				  $result = mysql_query("SELECT * FROM item WHERE sprice like '%$search%' ORDER BY itemcode")OR DIE('query is not available!');
    ...
    <script src="../build/js/custom.min.js"></script>
        ...
        search = document.myform.search.value;
  ...
  Display_Load();
    ...
    $("#content").load("search_pagination_data.php?page=1&search="+search, Hide_Load());
  ...
  $("#pagination li").click(function(){
    ...
    $("#content").load("search_pagination_data.php?page=" + pageNum+"&search="+search, Hide_Load());
  });
