      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          ...
          $adminauth = $_SESSION['admin']['auth'];
                ...
                <?php
                if (! empty($adminauth)) {
        $query = mysql_query("select * from admin where username='$adminauth' ");
        ...
        <div class="right_col" role="main">
                  ...
                  <div class="x_content">
                    <br />
                    <h1 class="welcome sorry" style="height:180px">Profile Edit Fail..<a href="memberRegister.php">Edit Again?</a></h1>
