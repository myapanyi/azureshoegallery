...
<head>
    ...
    <title>AzureShoeGallery|Products By Category</title>
	...
	<section>
		<div class="container">
			<div class="row">
				...
				<form name="myform">
						<input type="hidden" name="category" value="<?php echo $categoryCode ?>">

						</form>
						<?php

						$query = "SELECT * FROM item where categoryid = '$categoryCode' ";
...
<script type="text/javascript">
		categorysend = document.myform.category.value;
	...
	$("#content").load("selectedPagination.php?page=1&categoryid="+categorysend, Hide_Load());
	...
	$("#pagination li").click(function(){
		...
		$("#content").load("selectedPagination.php?page=" + pageNum+"&categoryid="+categorysend, Hide_Load());
	});
